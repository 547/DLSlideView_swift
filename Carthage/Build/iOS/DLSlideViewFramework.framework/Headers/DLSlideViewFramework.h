...
//! Project version number for DLSlideViewFramework.
FOUNDATION_EXPORT double DLSlideViewFrameworkVersionNumber;

//! Project version string for DLSlideViewFramework.
FOUNDATION_EXPORT const unsigned char DLSlideViewFrameworkVersionString[];
